...
export default class ActivityStore {
    activityRegistry = new Map<string,Activity>();//key and value te njejtes si activity edhe key edhe value
   ...
   updateAttendeeFollowing = (username: string) => { //activity nuser interface
